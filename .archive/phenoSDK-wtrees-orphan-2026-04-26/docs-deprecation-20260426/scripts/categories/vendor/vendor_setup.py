...
class VendorSetup:
    ...
    def __init__(self, project_dir: str | None = None):
        ...
        self.default_packages = [
            {
                "name": "typer",
                "reason": "CLI framework - critical for project",
                "required": True,
            },
            {
                "name": "rich",
                "reason": "Rich console output - essential for CLI",
                "required": True,
            },
            {
                "name": "click",
                "reason": "Click CLI library - optional fallback",
                "required": False,
            },
            {
                "name": "pydantic",
...
"""
    ...
    def complete_setup(self, force: bool = False) -> bool:
        ...
        if success:
            ...
            print(
                "  2. Verify package integrity: python scripts/vendor_setup.py verify",
            )
...
def main():
    ...
    parser.add_argument(
        "--setup-only",
        action="store_true",
        help="Only setup vendor system, don't add packages",
    )
