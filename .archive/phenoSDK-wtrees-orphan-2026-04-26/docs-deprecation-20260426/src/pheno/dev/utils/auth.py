...
Usage:
    from pheno.dev.utils.auth import TokenManager, decode_jwt
...
class TokenManager:
    ...
    def get_tokens(self, key: str) -> TokenSet | None:
    ...
    @classmethod
    def from_file(cls, path: str | Path) -> TokenManager:
...
class CredentialStore:
    ...
    @classmethod
    def from_file(cls, path: str | Path) -> CredentialStore:
...
class SessionManager:
    ...
    def get_credential(self, session_id: str, key: str) -> Any | None:
        """
