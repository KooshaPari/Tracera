...
def validate_bearer_token(authorization: str | None) -> str | None:
...
def validate_basic_auth(authorization: str | None) -> tuple[str, str] | None:
...
def has_scope(scopes_str: str | None, required_scopes: set[str]) -> bool:
...
def has_any_scope(scopes_str: str | None, allowed_scopes: set[str]) -> bool:
