...
class DependencyAnalyzer:
    ...
    def _analyze_pyproject(self, kit_name: str, file_path: Path):
        """
        ...
        try:
            ...
            if toml_lib is not None:
                ...
                # Minimal fallback: regex parse dependencies from pyproject as a last resort
                ...
                if proj_match:
                    ...
                    deps_match = re.search(r"dependencies\s*=\s*\[(.*?)\]", proj_block, re.DOTALL)
                    if deps_match:
    ...
    def suggest_consolidation_groups(self) -> dict[str, list[str]]:
        ...
        """
        groups = {"core": [], "data": [], "web": [], "infra": [], "ai": [], "ui": [], "dev": []}

        # Common patterns for each group
        patterns = {
            "core": ["pydantic", "cattrs", "dependency-injector", "typing", "dataclasses"],
            "data": [
                "asyncpg",
                "supabase",
                "redis",
            ...
            "ai": ["openai", "anthropic", "langchain", "transformers", "torch", "tensorflow"],
    ...
    def create_unified_dependencies(self) -> dict[str, list[str]]:
        ...
        unified = {"core": [], "data": [], "web": [], "infra": [], "ai": [], "ui": [], "dev": []}
