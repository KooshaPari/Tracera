...
try:
    from pheno.dev.performance.benchmarking import Benchmarker
    from pheno.dev.performance.metrics import ProviderBenchmark
    ...
    print("Warning: Some pheno modules not available, using simplified benchmark")

    class BenchmarkConfig:
        def __init__(self, iterations=3, warmup_iterations=1, verbose=True):
    ...
    class PerformanceBenchmark:
        ...
        def run_library_benchmark(self, test_name, test_func):
            class Result:
                def __init__(self, test_name, duration, config):
            ...
            return Result(test_name, end_time - start_time, self.config)
