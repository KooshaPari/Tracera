...
class InteractiveCredentialManager:
    ...
    def get_credentials(
        ...
        secure_fields: set[str] | None = None,
    ) -> dict[str, str]:
    ...
    def has_credentials(self, required_fields: list[str] | None = None) -> bool:
...
def prompt_for_value(
    ...
    while True:
        value = getpass.getpass(prompt_text) if secure else input(prompt_text)
