...
class TOTPHandler:
    ...
    def get_remaining_seconds(self, timestamp: float | None = None) -> int:
...
class MFAHandler:
    ...
    def __init__(self):
        ...
        self._sms_callback: Callable[[str, str], bool] | None = None
    ...
    def generate_totp(self, user_id: str) -> str | None:
