"""Abstract interfaces for the unified pheno.auth domain.

These were migrated from the standalone pheno-auth package so providers, token stores,
and MFA adapters across the ecosystem share one contract.
"""
