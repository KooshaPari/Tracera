...
These definitions originate from the legacy ``pheno-auth`` package and now serve as the
canonical dataclasses and error hierarchy shared across CLI, QA, and adapter contexts.
"""
