...
For full integration with pheno-sdk packages, ensure the configuration is included in the package data and properly referenced in each project's pyproject.toml.
