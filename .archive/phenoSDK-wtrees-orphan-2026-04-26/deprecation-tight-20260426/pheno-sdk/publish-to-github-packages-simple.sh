#!/bin/bash
# Simple script to publish pheno-sdk to GitHub Packages
...
# For GitHub Packages, we need to use the correct repository URL
# The format is: https://pypi.pkg.github.com/OWNER/REPOSITORY/
# Since we're publishing to the main organization, we use the organization name
