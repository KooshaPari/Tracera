...
def test_widget_creation():
    ...
    from pheno.mcp.qa.tui.widgets_compat import (
        OAuthStatusWidget,
    ...
    oauth_widget = OAuthStatusWidget(
        oauth_cache_client=MockOAuthClient(), _skip_deprecation_warning=True,
    )
    print("✓ OAuthStatusWidget created")

    # Test Server widget
    server_widget = ServerStatusWidget(
        client_adapter=MockMCPClient(), _skip_deprecation_warning=True,
    )
    ...
    resource_widget = ResourceStatusWidget(
        resource_config={"check_system": True}, _skip_deprecation_warning=True,
    )
...
def test_batch_creation():
    ...
    from pheno.mcp.qa.tui.widgets_compat import create_compatible_widgets
