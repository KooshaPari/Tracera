"""Authentication application service for the ``pheno`` namespace.

Provider and MFA registries live alongside the adapters to keep wiring explicit.
"""
...
from pheno.adapters.auth.mfa.registry import get_mfa_registry
...
if TYPE_CHECKING:
    from pheno.ports.auth.providers import CredentialManager, TokenManager
