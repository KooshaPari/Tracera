...
class TestFigmaMetadataDataclass:
    ...
    def test_base_url_with_file_name(self):
    ...
    def test_base_url_without_file_name(self):
...
class TestParseFigmaUrl:
    ...
    def test_parse_basic_file_url(self):
    ...
    def test_parse_url_with_complex_node_id(self):
    ...
    def test_parse_url_stores_full_url(self):
        """Test that full_url is stored."""
        url = "https://www.figma.com/file/abc123/MyProject?node-id=1:42"
        meta = parse_figma_url(url)
        assert meta.full_url == url

    def test_invalid_url_not_figma(self):
    ...
    def test_invalid_url_missing_file_key(self):
...
class TestIsFigmaUrl:
    ...
    def test_valid_url_with_node_id(self):
...
class TestBuildFigmaUrl:
    ...
    def test_build_url_with_special_chars_in_name(self):
...
class TestConvertFigmaProtocolToUrl:
    ...
    def test_convert_with_complex_node_ids(self):
...
class TestValidateFigmaMetadata:
    ...
    def test_validate_valid_metadata_with_node_id(self):
    ...
    def test_validate_mismatched_node_id(self):
