...
class TestMultiWayMergeScenarios:
    ...
    async def test_merge_cross_entity_dependencies(self, sync_engine):
        ...
        update_change = [c for c in link_changes if c.operation == OperationType.UPDATE][0]
...
class TestErrorRecoveryAndRetryLogic:
    ...
    async def test_exponential_backoff(self):
        ...
        assert (datetime.utcnow() - start).total_seconds() >= 0.01
