...
from tracertm.testing_factories import create_item, create_link, create_project
...
def mock_storage_adapter(tmp_path):
    ...
    with patch.object(adapter.storage, "get_project_storage") as mock_storage:
        ...
        mock_project_storage.get_project.return_value = create_project(
...
class TestBrowserAppIntegration:
    ...
    @pytest.mark.asyncio
    async def test_browser_app_launches_successfully(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_browser_displays_item_tree(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_browser_tree_navigation(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_browser_refresh_action(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_browser_filter_focus(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running BrowserApp
    ...
    @pytest.mark.asyncio
    async def test_browser_help_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running BrowserApp
    ...
    @pytest.mark.asyncio
    async def test_browser_quit_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running BrowserApp
    ...
    @pytest.mark.asyncio
    async def test_browser_handles_missing_database_config(
    ...
    @pytest.mark.asyncio
    async def test_browser_handles_empty_database(
        self, mock_config_manager, test_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_browser_child_item_rendering(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_browser_database_cleanup_on_exit(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_browser_view_filtering(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_browser_keyboard_shortcuts(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running BrowserApp
...
class TestDashboardAppIntegration:
    ...
    @pytest.mark.asyncio
    async def test_dashboard_app_launches_successfully(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Valid config and populated database
        ...
        """
        with patch("tracertm.tui.apps.dashboard.ConfigManager", return_value=mock_config_manager):
            with patch(
    ...
    @pytest.mark.asyncio
    async def test_dashboard_displays_statistics(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_dashboard_displays_items_table(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_dashboard_view_tree_setup(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_dashboard_switch_view_action(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_dashboard_view_tree_selection(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_dashboard_search_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running DashboardApp
    ...
    @pytest.mark.asyncio
    async def test_dashboard_help_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running DashboardApp
    ...
    @pytest.mark.asyncio
    async def test_dashboard_quit_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running DashboardApp
    ...
    @pytest.mark.asyncio
    async def test_dashboard_state_summary_display(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Database with items and links
    ...
    @pytest.mark.asyncio
    async def test_dashboard_items_table_pagination(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_dashboard_link_count_per_view(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_dashboard_cleanup_on_exit(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running DashboardApp
...
class TestEnhancedDashboardAppIntegration:
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_view_tree_setup(
        self, tmp_path, mock_config_manager
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_refresh_action(
        self, tmp_path, mock_config_manager
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_sync_action_no_engine(
        self, tmp_path, mock_config_manager
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_sync_action_with_engine(
        self, tmp_path, mock_config_manager
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_help_action(
        self, tmp_path, mock_config_manager
    ):
        """
        GIVEN: Running EnhancedDashboardApp
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_quit_action(
        self, tmp_path, mock_config_manager
    ):
        """
        GIVEN: Running EnhancedDashboardApp
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_sync_status_updates(
        self, tmp_path, mock_config_manager
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_handles_missing_project(
        self, tmp_path, mock_config_manager
    ):
        """
        GIVEN: Config without current project
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_items_display_source_info(
        self, tmp_path, mock_config_manager
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_view_tree_selection(
        self, tmp_path, mock_config_manager
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_search_not_implemented(
        self, tmp_path, mock_config_manager
    ):
        """
        GIVEN: Running EnhancedDashboardApp
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_callback_registration(
        self, tmp_path, mock_config_manager
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_enhanced_dashboard_item_change_callback(
        self, tmp_path, mock_config_manager
    ):
        """
        GIVEN: EnhancedDashboardApp with callbacks
...
class TestGraphAppIntegration:
    ...
    @pytest.mark.asyncio
    async def test_graph_app_launches_successfully(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Valid config and populated database
        ...
        """
        with patch("tracertm.tui.apps.graph.ConfigManager", return_value=mock_config_manager):
            with patch(
    ...
    @pytest.mark.asyncio
    async def test_graph_loads_nodes_and_links(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Database with items and links
    ...
    @pytest.mark.asyncio
    async def test_graph_displays_link_table(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_graph_displays_statistics(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_graph_refresh_action(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_graph_zoom_in_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running GraphApp
    ...
    @pytest.mark.asyncio
    async def test_graph_zoom_out_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running GraphApp
    ...
    @pytest.mark.asyncio
    async def test_graph_zoom_limits(
        self, mock_config_manager, populated_database
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_graph_help_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running GraphApp
    ...
    @pytest.mark.asyncio
    async def test_graph_quit_action(
        self, mock_config_manager, populated_database
    ):
        """
        GIVEN: Running GraphApp
...
class TestWidgetIntegration:
    ...
    async def test_conflict_panel_displays_conflict_list(self):
        ...
        from textual.app import App
        from tracertm.storage.conflict_resolver import Conflict
        from tracertm.storage.sync_engine import VectorClock
...
class TestStorageAdapterIntegration:
    ...
    def test_storage_adapter_update_item(self, tmp_path):
        ...
        updated = adapter.update_item(project, item.id, title="Updated Title")
    ...
    def test_storage_adapter_delete_item(self, tmp_path):
        ...
        adapter.delete_item(project, item.id)
    ...
    def test_storage_adapter_create_link(self, tmp_path):
        ...
        link = adapter.create_link(
            project, item1.id, item2.id, "implements"
        )
