...
For the isolated overlay, pass the repository as the Compose project root and
the overlay gateway explicitly. This validates the documented disposable
ports/build context without launching containers:
