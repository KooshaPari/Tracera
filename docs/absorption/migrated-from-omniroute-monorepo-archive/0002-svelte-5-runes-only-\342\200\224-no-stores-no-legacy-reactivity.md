# ADR-0002: Svelte 5 runes only — no stores, no legacy reactivity
...
USvelte 5 runes only — no stores, no legacy reactivity matters in this fork because the prior prototype
