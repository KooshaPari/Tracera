# ADR-0006: kbridge: Unix-socket + MessagePack-RPC for BFF ↔ gateway daemon
...
Ukbridge: Unix-socket + MessagePack-RPC for BFF ↔ gateway daemon matters in this fork because the prior prototype
