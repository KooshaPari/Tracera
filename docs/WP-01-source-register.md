...
_This register captures the baseline state. WP-02 will use these refs to establish assessment dimensions and WP-03 will build the ingestion pipeline against these output formats._
