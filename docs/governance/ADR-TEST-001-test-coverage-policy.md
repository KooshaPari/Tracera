...
- **Scope:** Enforcement applies to _modified_ files in the PR. New files must meet 100% coverage. Existing files will be brought into compliance via a "coverage debt" backlog.
...
_This ADR is a living document and may be updated as we learn more from its implementation._
