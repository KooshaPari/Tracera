...
"""
        ...
        if len(history) >= 2 and trend["change_percent"] < -1:
            alerts.append(f"⚠️ **Regression detected:** Coverage down {abs(trend['change_percent']):.2f}% in last 7 days")
...
def main():
    ...
    parser.add_argument("--format", choices=["markdown", "slack", "text"], default="markdown",
