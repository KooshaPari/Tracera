...
async def main():
    ...
    gates = [
        ...
        ("Dependency Audit Pass", "All npm/pip/go dependencies must pass security audit (npm audit, pip-audit, govulncheck).", 2, {"gate_type":"security","audit":True}, ["security","dependencies"]),
