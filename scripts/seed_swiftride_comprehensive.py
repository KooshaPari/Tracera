    ...
    business_objectives = [
        {
            ...
            "status": "in_progress",
            "priority": 5,
            "metadata": {"target": 1000000, "current": 250000, "deadline": "2026-Q4", "owner": "CPO", "metrics": ["MAU", "retention_rate"]},
        },
        {
            ...
            "status": "in_progress",
            "priority": 5,
            "metadata": {"target_cities": 15, "current_cities": 8, "criteria": ["population>500K", "smartphone_penetration>60%"]},
        },
        {
            ...
            "status": "todo",
            "priority": 4,
            "metadata": {"current_cac": 15.0, "target_cac": 10.50, "strategies": ["referral_bonus", "organic_growth", "partnership"]},
        },
        {
    ...
    kpis = [
        {
            ...
            "status": "complete",
            "priority": 5,
            "metadata": {"type": "retention", "target": 0.80, "current": 0.83, "measurement": "90_day_active", "frequency": "weekly"},
        },
        {
        ...
        },
        {
            ...
            "status": "complete",
            "priority": 5,
            "metadata": {"target": 0.02, "current": 0.015, "retry_success": 0.65, "top_reasons": ["insufficient_funds", "expired_card"]},
        },
    ]
    ...
    segments = [
        {
            ...
            "metadata": {"age_range": "25-45", "frequency": "5+ rides/week", "avg_fare": 18, "income": "50K-90K", "size": 420000},
        },
        {
            "title": "Airport travelers",
            "description": "Business and leisure travelers needing airport transportation",
            "metadata": {"frequency": "occasional", "avg_fare": 45, "price_sensitivity": "low", "luggage_needs": "high", "size": 180000},
        },
        {
            "title": "Late-night partiers",
            "description": "Weekend evening riders, bar/restaurant patrons, safety-focused",
            "metadata": {"peak_hours": "22:00-02:00", "days": "Fri-Sat", "avg_fare": 22, "safety_priority": "high", "size": 95000},
        },
    ]
...
def create_business_rules_policies(session: Session, project_id: uuid.UUID) -> Dict[str, List[Item]]:
    ...
    rules = [
        {
            ...
            "metadata": {"max_multiplier": 3.0, "applies_to": "all_tiers", "exceptions": "none", "effective_date": "2024-01-01"},
        },
        {
        ...
        },
        {
            ...
            "metadata": {"min_rating": 4.6, "sample_size": 100, "review_process": "quality_team", "appeal_window_days": 14},
        },
    ]
    ...
    policies = [
        ...
        },
        {
            ...
            "metadata": {"retention_years": 7, "applies_to": ["trip_history", "payment_data", "location_data"], "anonymization_method": "hashing"},
        },
    ]
...
def main():
    ...
    try:
        ...
        from seed_swiftride_part3 import create_operations_items, create_documentation_items, create_compliance_items, create_comprehensive_links
