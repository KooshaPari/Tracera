...
**Consequences**: +Scalability +Fault tolerance -Complexity -Eventual consistency""",
            "metadata": {"adr_number": 1, "status": "accepted", "decided_date": "2024-06-15", "stakeholders": ["CTO", "Lead Architect"]},
        },
        {
    ...
    microservices = [
        {
            ...
            "metadata": {"language": "Go", "framework": "none", "team": "matching", "dependencies": ["location-service", "pricing-service"], "sla": "99.9%"},
        },
        {
            "title": "Payment Processing Service",
            "description": "PCI-compliant payment processing with Stripe, fraud detection, and chargeback handling",
            "metadata": {"language": "Python", "framework": "FastAPI", "team": "payments", "pci_compliant": True, "integrations": ["Stripe", "PayPal"]},
        },
        {
            "title": "Location Service",
            "description": "GPS tracking, geofencing, ETA calculation, and route optimization",
            "metadata": {"language": "Go", "framework": "none", "team": "core", "update_frequency": "5s", "accuracy": "10m"},
        },
        {
            "title": "Notification Service",
            "description": "Multi-channel notifications via push, SMS, email with delivery tracking",
            "metadata": {"language": "Python", "framework": "FastAPI", "channels": ["FCM", "Twilio", "SendGrid"], "daily_volume": 500000},
        },
        {
            "title": "Pricing Service",
            "description": "Dynamic pricing engine with surge calculation, promotions, and fare estimation",
            "metadata": {"language": "Python", "framework": "FastAPI", "ml_model": "XGBoost", "features": ["surge", "promotions", "tipping"]},
        },
    ]
    ...
    api_contracts = [
        {
            ...
            "metadata": {
                "method": "POST",
                "path": "/v1/rides",
                "request_schema": {"pickup": "LatLng", "dropoff": "LatLng", "payment_method_id": "string", "rider_id": "uuid"},
    ...
    data_models = [
        {
            ...
            "metadata": {
                "fields": ["id:uuid", "rider_id:uuid", "driver_id:uuid", "status:enum", "pickup_location:point", "dropoff_location:point", "fare:decimal"],
        ...
        },
        {
            ...
            "metadata": {
                "fields": ["id:uuid", "user_id:uuid", "vehicle_id:uuid", "rating:decimal", "status:enum", "location:point"],
    ...
    events = [
        {
            ...
            "metadata": {"topic": "rides.requested", "schema": {"ride_id": "uuid", "rider_id": "uuid", "pickup": "LatLng", "timestamp": "datetime"}},
        },
        {
            "title": "RideMatched",
        ...
        },
        {
            ...
            "metadata": {"topic": "rides.completed", "schema": {"ride_id": "uuid", "distance_km": "float", "duration_seconds": "int", "fare": "decimal"}},
        },
    ]
...
def create_testing_items(session: Session, project_id: uuid.UUID) -> Dict[str, List[Item]]:
    ...
    test_plans = [
        {
            ...
            "metadata": {"scope": ["unit", "integration", "e2e"], "priority": "P0", "test_count": 47, "coverage_target": 0.90},
        },
        {
    ...
    test_scenarios = [
        {
            ...
            "metadata": {"type": "e2e", "steps": 12, "duration": "8min", "preconditions": ["active_driver_nearby", "valid_payment_method"]},
        },
        {
        ...
        },
        {
            ...
            "metadata": {"type": "integration", "trigger": "card_decline", "expected_outcome": "prompt_alternative_payment"},
        },
    ]
    ...
    benchmarks = [
        {
            ...
            "metadata": {"rps": 10000, "p95_latency_target": 500, "p99_latency_target": 1000, "success_rate_target": 0.999},
        },
        {
    ...
    vulnerabilities = [
        {
            ...
            "metadata": {"severity": "HIGH", "cvss": 7.5, "status": "MITIGATED", "mitigation": "GPS validation + accelerometer cross-check"},
        },
        {
            "title": "Payment token exposure in client logs",
            "description": "Sensitive payment tokens logged in plaintext on mobile apps",
            "metadata": {"severity": "CRITICAL", "cvss": 9.1, "status": "FIXED", "fix_version": "v2.3.1", "pci_violation": True},
        },
    ]
    ...
    for data in vulnerabilities:
        item = Item(
            ...
            status="complete" if data["metadata"]["status"] == "FIXED" else "in_progress",
            priority=5,
            item_metadata=data["metadata"],
        )
        session.add(item)
