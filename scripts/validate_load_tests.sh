...
if command -v k6 &> /dev/null; then
    ...
    echo "   Run: ./scripts/install_k6.sh"
    exit 1
fi
...
scripts=(
    ...
    "scripts/generate_load_test_report.py"
)
...
if [ -d "load-test-results" ]; then
    ...
    echo "   ⚠ load-test-results/ missing, creating..."
...
echo "  3. Run full suite: ./scripts/run_load_tests.sh"
echo "  4. View report: open load-test-results/report.html"
echo ""
echo "Documentation:"
