...
interface CollapsibleTriggerProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "onOpenChange"> {
	open?: boolean;
	onOpenChange?: (open: boolean) => void;
	children: React.ReactNode;
	className?: string;
...
interface CollapsibleContentProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "onOpenChange"> {
	open?: boolean;
	children: React.ReactNode;
	className?: string;
}
