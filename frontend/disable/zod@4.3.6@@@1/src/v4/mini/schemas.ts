...
export const ZodMiniXor: core.$constructor<ZodMiniXor> =
	/*@__PURE__*/ core.$constructor("ZodMiniXor", (inst, def) => {
...
export const ZodMiniExactOptional: core.$constructor<ZodMiniExactOptional> =
	/*@__PURE__*/ core.$constructor("ZodMiniExactOptional", (inst, def) => {
		core.$ZodExactOptional.init(inst, def);
		ZodMiniType.init(inst, def);
	});

// @__NO_SIDE_EFFECTS__
export function exactOptional<T extends SomeType>(
	innerType: T,
