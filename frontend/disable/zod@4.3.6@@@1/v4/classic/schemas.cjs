...
exports.ZodType = core.$constructor("ZodType", (inst, def) => {
	...
	Object.assign(inst["~standard"], {
		jsonSchema: {
			input: (0, to_json_schema_js_1.createStandardJSONSchemaMethod)(
				inst,
				"input",
			),
			output: (0, to_json_schema_js_1.createStandardJSONSchemaMethod)(
				inst,
				"output",
			),
		},
	});
	inst.toJSONSchema = (0, to_json_schema_js_1.createToJSONSchemaMethod)(
		inst,
		{},
	);
	inst.def = def;
...
exports.ZodNumber = core.$constructor("ZodNumber", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.numberProcessor(inst, ctx, json, params);
...
exports.ZodBoolean = core.$constructor("ZodBoolean", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.booleanProcessor(inst, ctx, json, params);
});
...
exports.ZodBigInt = core.$constructor("ZodBigInt", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.bigintProcessor(inst, ctx, json, params);
	inst.gte = (value, params) => inst.check(checks.gte(value, params));
	inst.min = (value, params) => inst.check(checks.gte(value, params));
	inst.gt = (value, params) => inst.check(checks.gt(value, params));
	inst.gte = (value, params) => inst.check(checks.gte(value, params));
...
exports.ZodSymbol = core.$constructor("ZodSymbol", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.symbolProcessor(inst, ctx, json, params);
});
...
exports.ZodUndefined = core.$constructor("ZodUndefined", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.undefinedProcessor(inst, ctx, json, params);
});
...
exports.ZodNull = core.$constructor("ZodNull", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.nullProcessor(inst, ctx, json, params);
});
...
exports.ZodAny = core.$constructor("ZodAny", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.anyProcessor(inst, ctx, json, params);
});
function any() {
...
exports.ZodUnknown = core.$constructor("ZodUnknown", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.unknownProcessor(inst, ctx, json, params);
});
function unknown() {
...
exports.ZodNever = core.$constructor("ZodNever", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.neverProcessor(inst, ctx, json, params);
});
...
exports.ZodVoid = core.$constructor("ZodVoid", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.voidProcessor(inst, ctx, json, params);
});
...
exports.ZodDate = core.$constructor("ZodDate", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.dateProcessor(inst, ctx, json, params);
	inst.min = (value, params) => inst.check(checks.gte(value, params));
	inst.max = (value, params) => inst.check(checks.lte(value, params));
...
exports.ZodArray = core.$constructor("ZodArray", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.arrayProcessor(inst, ctx, json, params);
...
exports.ZodObject = core.$constructor("ZodObject", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.objectProcessor(inst, ctx, json, params);
...
exports.ZodUnion = core.$constructor("ZodUnion", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.unionProcessor(inst, ctx, json, params);
...
exports.ZodIntersection = core.$constructor("ZodIntersection", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.intersectionProcessor(inst, ctx, json, params);
});
...
exports.ZodTuple = core.$constructor("ZodTuple", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.tupleProcessor(inst, ctx, json, params);
	inst.rest = (rest) =>
		inst.clone({
			...inst._zod.def,
			rest: rest,
...
exports.ZodRecord = core.$constructor("ZodRecord", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.recordProcessor(inst, ctx, json, params);
...
exports.ZodMap = core.$constructor("ZodMap", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.mapProcessor(inst, ctx, json, params);
	inst.keyType = def.keyType;
	inst.valueType = def.valueType;
...
exports.ZodSet = core.$constructor("ZodSet", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.setProcessor(inst, ctx, json, params);
	inst.min = (...args) => inst.check(core._minSize(...args));
	inst.nonempty = (params) => inst.check(core._minSize(1, params));
	inst.max = (...args) => inst.check(core._maxSize(...args));
	inst.size = (...args) => inst.check(core._size(...args));
...
exports.ZodEnum = core.$constructor("ZodEnum", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.enumProcessor(inst, ctx, json, params);
...
exports.ZodLiteral = core.$constructor("ZodLiteral", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.literalProcessor(inst, ctx, json, params);
...
exports.ZodFile = core.$constructor("ZodFile", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.fileProcessor(inst, ctx, json, params);
...
exports.ZodTransform = core.$constructor("ZodTransform", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.transformProcessor(inst, ctx, json, params);
...
exports.ZodOptional = core.$constructor("ZodOptional", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.optionalProcessor(inst, ctx, json, params);
...
exports.ZodExactOptional = core.$constructor(
	"ZodExactOptional",
	(inst, def) => {
...
exports.ZodNullable = core.$constructor("ZodNullable", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.nullableProcessor(inst, ctx, json, params);
	inst.unwrap = () => inst._zod.def.innerType;
});
...
exports.ZodDefault = core.$constructor("ZodDefault", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.defaultProcessor(inst, ctx, json, params);
	inst.unwrap = () => inst._zod.def.innerType;
...
exports.ZodPrefault = core.$constructor("ZodPrefault", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.prefaultProcessor(inst, ctx, json, params);
	inst.unwrap = () => inst._zod.def.innerType;
});
...
exports.ZodNonOptional = core.$constructor("ZodNonOptional", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.nonoptionalProcessor(inst, ctx, json, params);
	inst.unwrap = () => inst._zod.def.innerType;
});
...
exports.ZodSuccess = core.$constructor("ZodSuccess", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.successProcessor(inst, ctx, json, params);
	inst.unwrap = () => inst._zod.def.innerType;
});
...
exports.ZodCatch = core.$constructor("ZodCatch", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.catchProcessor(inst, ctx, json, params);
	inst.unwrap = () => inst._zod.def.innerType;
...
exports.ZodNaN = core.$constructor("ZodNaN", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.nanProcessor(inst, ctx, json, params);
});
function nan(params) {
...
exports.ZodPipe = core.$constructor("ZodPipe", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.pipeProcessor(inst, ctx, json, params);
	inst.in = def.in;
	inst.out = def.out;
});
...
exports.ZodReadonly = core.$constructor("ZodReadonly", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.readonlyProcessor(inst, ctx, json, params);
	inst.unwrap = () => inst._zod.def.innerType;
});
...
exports.ZodTemplateLiteral = core.$constructor(
	...
	(inst, def) => {
		...
		exports.ZodType.init(inst, def);
		inst._zod.processJSONSchema = (ctx, json, params) =>
			processors.templateLiteralProcessor(inst, ctx, json, params);
	},
);
...
exports.ZodLazy = core.$constructor("ZodLazy", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.lazyProcessor(inst, ctx, json, params);
...
exports.ZodPromise = core.$constructor("ZodPromise", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.promiseProcessor(inst, ctx, json, params);
	inst.unwrap = () => inst._zod.def.innerType;
});
...
exports.ZodFunction = core.$constructor("ZodFunction", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.functionProcessor(inst, ctx, json, params);
});
...
exports.ZodCustom = core.$constructor("ZodCustom", (inst, def) => {
	...
	exports.ZodType.init(inst, def);
	inst._zod.processJSONSchema = (ctx, json, params) =>
		processors.customProcessor(inst, ctx, json, params);
});
// custom checks
function check(fn) {
