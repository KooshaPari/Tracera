...
exports.createStandardJSONSchemaMethod = exports.createToJSONSchemaMethod =
	void 0;
	...
	try {
		...
		Object.defineProperty(finalized, "~standard", {
			value: {
				...schema["~standard"],
				jsonSchema: {
					input: (0, exports.createStandardJSONSchemaMethod)(
						schema,
						"input",
						ctx.processors,
					),
					output: (0, exports.createStandardJSONSchemaMethod)(
						schema,
						"output",
						ctx.processors,
					),
