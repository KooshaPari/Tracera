...
const handleCreate = (formData) => mutate({
  projectId,
  name: formData.name,
  type: "user",
...
["equivalences", "list", projectId] // Specific project
["equivalences", "detail", equivalenceId] // Specific item

// Canonical
["canonical", "list", projectId] // Concepts in project
["canonical", "projections", conceptId] // Items for concept
["canonical", "pivots", itemId] // Pivot targets

// Journeys
["journeys", "list", projectId, type] // Journeys
["journeys", "steps", journeyId] // Steps

// Component Library
["componentLibrary", "list", projectId] // Libraries
["componentLibrary", "components", libraryId] // Components
["componentLibrary", "tokens", libraryId] // Tokens
["componentLibrary", "usage", componentId] // Usage
```
