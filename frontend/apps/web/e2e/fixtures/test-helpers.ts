...
export class TestDataGenerator {
  ...
  static randomItem() {
    return {
      title: `Test Item ${this.randomString()}`,
      description: `Description for test item ${this.randomString()}`,
  ...
  static randomProject() {
    return {
      name: `Test Project ${this.randomString()}`,
      description: `Description for test project ${this.randomString()}`,
    }
  }

  static randomAgent() {
    return {
      name: `Test Agent ${this.randomString()}`,
