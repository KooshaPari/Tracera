...
export default defineConfig({
  build: {
    // Output to frontend/dist so tracera-server's ServeDir (crates/tracera-server/src/main.rs,
    // default TRACERA_FRONTEND_DIST="frontend/dist") can serve the built assets directly.
    outDir: '../../dist',
    emptyOutDir: true,
