    ...
    return (
      <div className="space-y-2">
        ...
        <div className="text-xs text-muted-foreground text-center">
          Current: {fpsStats.current.toFixed(1)} FPS |
          Average: {fpsStats.average.toFixed(1)} FPS
        </div>
      </div>
    );
  },
    ...
    return (
      <div className="relative w-[1000px] h-[600px] bg-muted rounded border p-4">
        ...
        <div className="absolute bottom-4 left-4 text-sm text-muted-foreground">
          <p>FPS Range: {fpsStats.min.toFixed(1)} - {fpsStats.max.toFixed(1)}</p>
      ...
      <div className="space-y-4">
        <div className="flex gap-2">
          <button
            ...
            onClick={() => setVariant(variant === 'compact' ? 'detailed' : 'compact')}
          >
            Toggle Variant
          </button>
        </div>
