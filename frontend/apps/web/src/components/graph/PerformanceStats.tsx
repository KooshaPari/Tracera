      ...
      <CardContent className="space-y-3">
        ...
        <div className="space-y-1">
          <div className="flex justify-between text-xs">
            ...
            <span className={`font-medium ${fpsColor}`}>{Math.round(fps)} FPS</span>
          </div>
        ...
        <div className="space-y-1">
          ...
          <Progress value={(visibleNodeCount / nodeCount) * 100} className="h-1" />
        </div>
        ...
        <div className="space-y-1">
          ...
          <Progress value={(visibleEdgeCount / edgeCount) * 100} className="h-1" />
        </div>
