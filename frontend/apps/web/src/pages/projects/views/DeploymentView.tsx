...
import { DEPLOYMENT_SITE_URLS } from "@/config/deployment-origin";
...
const environments: Environment[] = [
  {
    ...
    name: "Production",
    status: "healthy",
    url: DEPLOYMENT_SITE_URLS.production,
  },
  {
    lastDeploy: {
      branch: "develop",
    ...
    name: "Staging",
    status: "healthy",
    url: DEPLOYMENT_SITE_URLS.staging,
  },
  {
    lastDeploy: {
    ...
    name: "Development",
    status: "degraded",
    url: DEPLOYMENT_SITE_URLS.development,
  },
];
          ...
          <div key={env.name} className="rounded-lg border p-4">
            <div className="flex items-center justify-between">
              ...
              {env.url ? (
                ...
                <span className="text-muted-foreground text-xs">URL not configured</span>
              )}
            </div>
            {env.lastDeploy && (
