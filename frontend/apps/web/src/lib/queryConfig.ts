...
export const queryKeys = {
	...
	items: {
		...
		list: (projectId: string) =>
			[...queryKeys.items.all, "list", projectId] as const,
	...
	links: {
		all: ["links"] as const,
		list: (projectId: string) =>
			[...queryKeys.links.all, "list", projectId] as const,
		byItem: (itemId: string) =>
			[...queryKeys.links.all, "byItem", itemId] as const,
	},
	...
	graph: {
		...
		full: (projectId: string) =>
			[...queryKeys.graph.all, "full", projectId] as const,
		...
		impact: (itemId: string) =>
			[...queryKeys.graph.all, "impact", itemId] as const,
	},
	...
	specs: {
		all: ["specs"] as const,
		list: (projectId: string) =>
			[...queryKeys.specs.all, "list", projectId] as const,
	...
	executions: {
		...
		list: (projectId: string) =>
			[...queryKeys.executions.all, "list", projectId] as const,
		detail: (id: string) =>
			[...queryKeys.executions.all, "detail", id] as const,
	},
	...
	codex: {
		all: ["codex"] as const,
		list: (projectId: string) =>
			[...queryKeys.codex.all, "list", projectId] as const,
