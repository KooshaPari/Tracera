...
import type { Item, Project, SearchResult } from '../api/types'
...
export function AdvancedSearchView() {
  ...
  const searchQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`/api/v1/projects/${filters.project_id || 'all'}/search/advanced`, {
        method: 'POST',
          ...
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as typeof activeTab)}>
            ...
            <TabsContent value="items" className="space-y-4 mt-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="view-filter" className="block text-sm font-medium mb-2">
                    View
                  </label>
                  <Select
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="created-after" className="block text-sm font-medium mb-2">
                    Created After
                  </label>
                  <Input
                    id="created-after"
                ...
                <div>
                  <label htmlFor="created-before" className="block text-sm font-medium mb-2">
                    Created Before
                  </label>
                  <Input
                    id="created-before"
            ...
            <TabsContent value="links" className="space-y-4 mt-4">
              <div>
                <label htmlFor="link-type-filter" className="block text-sm font-medium mb-2">
                  Link Type
                </label>
                <Select
                  value={filters.view || 'all'}
        ...
        <div>
          ...
          {results.length > 0 ? (
            ...
            <Card className="p-12 text-center text-gray-500">
              ...
              {query && <p className="text-sm mt-2">Try adjusting your filters</p>}
            </Card>
          )}
        </div>
      )}
