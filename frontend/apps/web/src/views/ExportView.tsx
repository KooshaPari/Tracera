      ...
      {projectId && (
        <Card className="p-6 bg-blue-50 dark:bg-blue-900/20">
          ...
          <p className="text-sm text-gray-600">
            Project ID: <code className="bg-white dark:bg-gray-800 px-2 py-1 rounded">{projectId}</code>
          </p>
          <p className="text-sm text-gray-600 mt-2">
            Format: <code className="bg-white dark:bg-gray-800 px-2 py-1 rounded">{format.toUpperCase()}</code>
          </p>
        </Card>
      )}
    </div>
