...
describe('EmptyState Component', () => {
  ...
  describe('Actions', () => {
    ...
    it('should not render action container when no actions provided', () => {
      ...
      const actionContainer = container.querySelector('.flex.items-center.space-x-3')
  ...
  describe('Combined Props', () => {
    it('should render all props together', () => {
      ...
      expect(screen.getByText("You haven't created any documents yet")).toBeInTheDocument()
  ...
  describe('Styling and Layout', () => {
    ...
    it('should render icon with correct container classes', () => {
      ...
      const iconContainer = container.querySelector('.w-16.h-16')
      expect(iconContainer).toHaveClass('rounded-full', 'bg-gray-100', 'dark:bg-gray-800')
    })
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle empty string title', () => {
      ...
      expect(container.querySelector('.text-lg.font-semibold')).toBeInTheDocument()
    })
  ...
  describe('Real-world Scenarios', () => {
    it('should render empty projects state', () => {
      ...
      expect(screen.getByText('Create your first project to start managing requirements')).toBeInTheDocument()
