...
describe('Projects List Page', () => {
    ...
    it('shows loading state when refetching', async () => {
      ...
      vi.mocked(fetchProjects).mockImplementation(
        () =>
          new Promise((resolve) =>
            setTimeout(
              () => resolve({ data: [{ id: '1', name: 'Project 1 Updated' }], total: 1 }),
              50
            )
          )
      )
  ...
  describe('Filtering', () => {
    ...
    it('combines multiple filters', async () => {
      ...
      vi.mocked(fetchProjects).mockResolvedValue({
        data: [
          { id: '1', name: 'Active New', status: 'active', created_at: '2024-06-01' },
          { id: '2', name: 'Active Old', status: 'active', created_at: '2023-01-01' },
          { id: '3', name: 'Archived New', status: 'archived', created_at: '2024-06-01' },
        ],
        total: 3,
      })
  ...
  describe('Pagination', () => {
    ...
    it('changes page size', async () => {
      ...
      vi.mocked(fetchProjects).mockResolvedValue({
        data: Array.from({ length: 50 }, (_, i) => ({ id: `${i}`, name: `Project ${i}` })),
        total: 150,
        page: 1,
        pageSize: 50,
      })
  ...
  describe('Project Actions', () => {
    ...
    it('deletes project with confirmation', async () => {
      ...
      const deleteButton = screen.getByRole('button', { name: /delete project proj-123/i })
  ...
  describe('Bulk Operations', () => {
    it('selects multiple projects', async () => {
      ...
      const checkbox1 = screen.getByRole('checkbox', { name: /select project 1/i })
      const checkbox2 = screen.getByRole('checkbox', { name: /select project 2/i })
