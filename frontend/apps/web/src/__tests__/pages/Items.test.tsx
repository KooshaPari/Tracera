...
describe('Items Page', () => {
  ...
  describe('Page Rendering', () => {
    it('renders items page with table view', async () => {
      ...
      vi.mocked(fetchItems).mockResolvedValue({
        data: [
          { id: '1', title: 'Feature A', type: 'feature', status: 'active', priority: 'high' },
          { id: '2', title: 'Bug B', type: 'bug', status: 'done', priority: 'critical' },
        ],
        total: 2,
      })
  ...
  describe('Filtering', () => {
    ...
    it('filters by assignee', async () => {
      ...
      const assigneeFilter = screen.getByRole('combobox', { name: /filter by assignee/i })
  ...
  describe('Sorting', () => {
    it('sorts by title ascending', async () => {
      ...
      await userEvent.click(screen.getByRole('option', { name: /title \(a-z\)/i }))
  ...
  describe('Bulk Operations', () => {
    it('selects multiple items', async () => {
      ...
      await userEvent.click(screen.getByRole('checkbox', { name: /select item 1/i }))
      await userEvent.click(screen.getByRole('checkbox', { name: /select item 2/i }))
    ...
    it('bulk updates status', async () => {
      ...
      await userEvent.click(screen.getByRole('menuitem', { name: /change status/i }))
  ...
  describe('Kanban View', () => {
    it('displays items in status columns', async () => {
      ...
      await userEvent.click(screen.getByRole('button', { name: /kanban view/i }))
      ...
      expect(within(progressColumn).getByText(/Progress Item/i)).toBeInTheDocument()
