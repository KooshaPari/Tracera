...
class IntegrationCredential(Base, TimestampMixin):
    ...
    github_app_installation_id: Mapped[Optional[str]] = mapped_column(
        String(36), ForeignKey("github_app_installations.id", ondelete="SET NULL"), nullable=True, index=True
    )
    linear_app_installation_id: Mapped[Optional[str]] = mapped_column(
    ...
    validation_error: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
    ...
    rotation_required_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
...
class IntegrationMapping(Base, TimestampMixin):
    ...
    last_sync_direction: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    sync_error_message: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
    consecutive_failures: Mapped[int] = mapped_column(Integer, default=0, nullable=False)

    # Conflict tracking
    last_conflict_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
...
class IntegrationConflict(Base):
    ...
    tracertm_value: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    resolution_strategy_used: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
