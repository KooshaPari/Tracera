"""Agent registration and management for the TraceRTM Python API client."""
...
class ClientAgentsMixin:
    """Mixin for TraceRTMClient to handle agent registration and management."""
