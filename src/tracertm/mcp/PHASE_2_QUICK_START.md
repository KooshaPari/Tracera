...
- `query_items_v2()` - Query with optimization
- `update_item_v2()` - Update with lean response
- `delete_item_v2()` - Delete with confirmation
...
|----------|------|---------|
| Get single item | `get_item_v2()` | 88% fewer tokens |
| Query <50 items | `query_items_v2()` | 84% fewer tokens |
...
# Step 3: Switch to v2
result = await query_items_v2(...)  # Production
```
