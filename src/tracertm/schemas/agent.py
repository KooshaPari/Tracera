...
class AgentSessionCreate(BaseModel):
    ...
    project_id: Optional[str] = Field(default=None, description="Optional project to scope the session")
    session_id: Optional[str] = Field(default=None, description="Optional explicit session ID; otherwise generated")
...
class AgentRunRequest(BaseModel):
    ...
    initial_messages_json: Optional[str] = Field(default=None, description="JSON array of message dicts to start from")
