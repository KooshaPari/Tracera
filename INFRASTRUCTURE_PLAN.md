...
- `TRACERA_PUBLIC_BIND_MODE` - "authenticated-proxy" when ingress auth is active
...
1. [x] Document self-host stack (`deploy/selfhost/`)
2. [ ] Fix Vercel frontend API URL
3. [ ] Operate self-hosted backend behind Cloudflare Tunnel
