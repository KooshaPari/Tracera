...
func (m *MockCodeIndexService) UpdateEntity(ctx context.Context, entityID string, description string, metadata json.RawMessage) (*models.CodeEntity, error) {
...
func (m *MockCodeIndexService) SearchEntities(ctx context.Context, projectID, query string, limit, offset int) ([]*models.CodeEntity, error) {
