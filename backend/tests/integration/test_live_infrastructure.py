...
@pytest.mark.live
@pytest.mark.asyncio
async def test_live_postgres_access(db_session):
...
@pytest.mark.live
@pytest.mark.asyncio
async def test_live_neo4j_access(neo4j_driver):
...
@pytest.mark.live
@pytest.mark.asyncio
async def test_live_redis_access(redis_client):
...
@pytest.mark.live
@pytest.mark.asyncio
async def test_live_nats_access(nats_client):
...
@pytest.mark.live
@pytest.mark.asyncio
async def test_live_full_infra_check(db_session, neo4j_driver, redis_client, nats_client):
