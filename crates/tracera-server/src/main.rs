...
struct AppState {
    ...
    neo4j: Option<Arc<tracera_server::neo4j::Neo4jClient>>,
...
fn build_router_with_auth(state: AppState, auth_token: auth::AuthToken) -> Router {
    ...
    Router::new()
        ...
        .route(
            "/api/v1/storage/artifacts/{id}/upload",
            any(not_implemented),
        )
        ...
        .route(
            "/api/v1/distributed/tasks/{id}/complete",
            any(not_implemented),
        )
        ...
        .route(
            "/api/v1/distributed/queues/{id}/enqueue",
            any(not_implemented),
        )
        .route(
            "/api/v1/distributed/queues/{id}/dequeue",
            any(not_implemented),
        )
