...
fn build_router_with_auth(state: AppState, auth_token: auth::AuthToken) -> Router {
    Router::new()
        ...
        .route("/api/v1/links", get(not_implemented).post(not_implemented))
        .route("/api/v1/links/{id}", get(not_implemented).put(not_implemented).delete(not_implemented))
        .route("/api/v1/graph/forward/{id}", get(not_implemented))
        .route("/api/v1/graph/reverse/{id}", get(not_implemented))
        .route("/api/v1/graph/adjacency", get(not_implemented))
        .route("/api/v1/graph/communities", get(not_implemented))
        .route("/api/v1/graph/impact", get(not_implemented))
        .route("/api/v1/graph/path", get(not_implemented))
        .route("/api/v1/search", get(not_implemented))
        .route("/api/v1/search/fulltext", get(not_implemented))
        .route("/api/v1/search/similar", get(not_implemented))
        .route("/api/v1/projects/{id}/members", get(not_implemented).post(not_implemented))
        .route("/api/v1/auth/login", post(not_implemented))
        .route("/api/v1/auth/logout", post(not_implemented))
        .route("/api/v1/auth/refresh", post(not_implemented))
        .route("/api/v1/equivalences", get(not_implemented).post(not_implemented))
        ...
        .route("/api/v1/journeys", get(not_implemented).post(not_implemented))
        .route("/api/v1/journeys/{id}", get(not_implemented).put(not_implemented).delete(not_implemented))
        .route("/api/v1/journeys/{id}/events", get(not_implemented).post(not_implemented))
        .route("/api/v1/components", get(not_implemented).post(not_implemented))
        .route("/api/v1/components/{id}", get(not_implemented).put(not_implemented).delete(not_implemented))
        .route("/api/v1/components/{id}/dependencies", get(not_implemented))
        .route("/api/v1/codex/entries", get(not_implemented).post(not_implemented))
        .route("/api/v1/codex/entries/{id}", get(not_implemented).put(not_implemented).delete(not_implemented))
        .route("/api/v1/codex/search", get(not_implemented))
        .route("/api/v1/docs", get(not_implemented).post(not_implemented))
        .route("/api/v1/docs/{id}", get(not_implemented).put(not_implemented).delete(not_implemented))
        .route("/api/v1/ai/infer", post(not_implemented))
        .route("/api/v1/ai/suggest", post(not_implemented))
        .route("/api/v1/ai/classify", post(not_implemented))
        .route("/api/v1/executions", get(not_implemented).post(not_implemented))
        .route("/api/v1/executions/{id}", get(not_implemented))
        .route("/api/v1/executions/{id}/logs", get(not_implemented))
        .route("/api/v1/executions/{id}/cancel", post(not_implemented))
        .route("/api/v1/executions/{id}/rerun", post(not_implemented))
        .route("/api/v1/storage/artifacts", get(not_implemented).post(not_implemented))
        .route("/api/v1/storage/artifacts/{id}", get(not_implemented).delete(not_implemented))
        .route("/api/v1/storage/artifacts/{id}/download", get(not_implemented))
        .route("/api/v1/storage/artifacts/{id}/upload", post(not_implemented))
        .route("/api/v1/distributed/agents", get(not_implemented).post(not_implemented))
        .route("/api/v1/distributed/agents/{id}", get(not_implemented).delete(not_implemented))
        .route("/api/v1/distributed/tasks", get(not_implemented).post(not_implemented))
        .route("/api/v1/distributed/tasks/{id}", get(not_implemented))
        .route("/api/v1/distributed/tasks/{id}/claim", post(not_implemented))
        .route("/api/v1/distributed/tasks/{id}/complete", post(not_implemented))
        .route("/api/v1/distributed/tasks/{id}/fail", post(not_implemented))
        .route("/api/v1/distributed/queues", get(not_implemented).post(not_implemented))
        .route("/api/v1/distributed/queues/{id}", get(not_implemented))
        .route("/api/v1/distributed/queues/{id}/enqueue", post(not_implemented))
        .route("/api/v1/distributed/queues/{id}/dequeue", post(not_implemented))
        .route("/api/v1/distributed/locks", get(not_implemented).post(not_implemented))
        .route("/api/v1/distributed/locks/{id}", get(not_implemented).delete(not_implemented))
        .route("/api/v1/sync/status", get(not_implemented))
        .route("/api/v1/sync/import", post(not_implemented))
        .route("/api/v1/sync/export", get(not_implemented))
        .route("/api/v1/sync/diff", get(not_implemented))
        .route("/api/v1/sync/merge", post(not_implemented))
        .route("/api/v1/sync/history", get(not_implemented))
        .with_state(state)
}
