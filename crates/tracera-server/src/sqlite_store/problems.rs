...
use crate::store::{BoxFuture, ListParams, Problem, StoreError, StoreResult};

use super::{str_to_opt_ts, str_to_ts};

pub(super) fn row_to_problem(r: sqlx::sqlite::SqliteRow) -> Problem {
...
pub(super) fn count_problems_filtered(
    pool: &SqlitePool,
    project_id: String,
    status_filter: Option<String>,
