-- SQLite-dialect problem-management table (mirrors Postgres migration 0007).
-- Projects are derived from non-deleted problem rows, so this table is also
-- required for the /api/v1/projects read contract.
