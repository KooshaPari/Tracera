...
down_revision: Union[str, None] = '006_add_priority_owner'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('parent_version_id', sa.String(255), sa.ForeignKey('processes.id', ondelete='SET NULL'), nullable=True),
